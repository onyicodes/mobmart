...
import 'package:mobmart_app/core/util/logout_user.dart';

class SettingsController extends GetxController {
  final GetStorage storeBox;

  SettingsController({required this.storeBox});
  ...
  logout() async {
    ...
    customSnackbar(
        title: "Success", message: LocaleKeysSettingsTexts.logoutSuccess);
  }
}
