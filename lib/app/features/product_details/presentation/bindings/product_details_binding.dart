...
import 'package:mobmart/app/features/product_details/data/repository/product_details_repository_impl.dart';
...
class ProductDetailsBinding implements Bindings {
  ...
  void dependencies() {
    productDetailsControllerSl
        .lazyPut<ProductDetailsController>(() => ProductDetailsController(fetchRecommendationsUsecase: productDetailsControllerSl()));
