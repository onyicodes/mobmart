...
class SuccessPage extends GetView<SignupController> {
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      ...
      child: Column(
        children: [
          CustomListSpacing(spacingValue: ListSpacingValue.spacingV100.value),
          CustomListSpacing(spacingValue: ListSpacingValue.spacingV100.value),
          Padding(
          ...
          Padding(
            ...
            child: GetX<SignupController>(builder: (_) {
              return CustomButton(
                label: LocaleKeysAuthFieldText.continueToAppButton,
                onPressed: () {
                  _.signInUser(
                      email: _.emailAddressController.text.trim(),
