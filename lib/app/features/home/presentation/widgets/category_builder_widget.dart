...
import 'package:mobmart/app/features/home/presentation/widgets/category_widget.dart';
  ...
  Widget build(BuildContext context) {
    return Padding(
      ...
      child: Row(
        ...
        children: categoryEntityList.map((category) => CategoryWidget(image:category.icon, title: category.label,)).toList()),
    );
  }
}
